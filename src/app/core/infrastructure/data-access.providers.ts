...
import { InMemoryCertificationRepository } from './repositories/in-memory-certification.repository';
...
export const dataAccessProviders: Provider[] = [
  ...
  { provide: CERTIFICATION_REPOSITORY, useClass: InMemoryCertificationRepository },
];
